...
praisewidget.text = "Yahwey RULES!"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- local layouts = { l.floating, l.title, l.floating, l.fair, l.max, l.floating, l.tile.left, l.floating, l.floating }
